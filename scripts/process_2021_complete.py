"""Complete 2021 PPR update - parse data, create season file, update HTML"""
...
print("="*70)
print("PROCESSING 2021 PPR DATA - COMPLETE")
print("="*70)
...
with open('data/drafts/2021.json', 'r', encoding='utf-8') as f:
    draft_2021 = json.load(f)
...
ppr_entries = []
try:
    with open('data/2021_ppr_raw.txt', 'r', encoding='utf-8') as f:
    ...
    print("  ⚠️  data/2021_ppr_raw.txt not found")
    print("  💡 Please save the full 2021 PPR data to this file")
    exit(1)
...
# Save season data
with open('data/seasons/2021.json', 'w', encoding='utf-8') as f:
    json.dump(season_2021, f, indent=2, ensure_ascii=False)

print(f"\n✅ Created data/seasons/2021.json")

# Create lookup for season data
season_lookup = {}
for pos, rankings in season_2021['ppr_rankings'].items():
...
# Find 2021 draft section
start_tag = 'id="draft-2021"'
start_index = html.find(start_tag)
if start_index == -1:
    print("  ❌ 2021 draft section not found!")
    exit(1)
...
print(f"  ✅ Updated {len(draft_2021['picks'])} rows in HTML")

print("\n" + "="*70)
print("✅ 2021 DRAFT UPDATE COMPLETE!")
print("="*70)
print(f"\nCreated:")
print(f"  - data/seasons/2021.json")
